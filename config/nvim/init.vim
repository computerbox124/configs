...
command! -nargs=0 CompileAndRun call TermWrapper(printf('g++ -std=c++1y %s && ./a.out', expand('%')))
command! -nargs=1 -complete=file CompileAndRunWithFile call TermWrapper(printf('g++ -std=c++1y %s && ./a.out < %s', expand('%'), <q-args>))
